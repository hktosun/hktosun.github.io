...
# gets the necessary data from the Top 200 list (songs, artists, listen counts, and ranks in each country at each date).
...
def get_data(country):
    ...
    for link in links:
        ...
        for i, (entry, stream) in enumerate(zip(entries,streams)):
            ...
            rows.append([song,artist, link[48:58], play_count, i+1])
